...
> [!NOTE]
> Torrent seeding typically needs UDP as well as TCP. If your environment supports it, also expose port `42069/udp`.
  ...
  stremio-ncore-addon:
    ...
    volumes:
      - type: bind
        ...
        target: /addon
x-casaos:
  icon: https://<your-addon-url>/stremio-ncore-addon-logo-rounded.png
  scheme: https
  title:
